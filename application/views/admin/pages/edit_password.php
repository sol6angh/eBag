		...
		<?php echo form_open(base_url() . 'admin/Admin/update_password/' . $user->id); ?>
			  <div class="row">
					<div class="col-md-6">
				...
				<div class="row">
					...
					<?php endif; ?>
							...
							<input class="form-control" type="text" name="newpass" placeholder="" required/>
						</div>
						<div class="form-group">
							<label>Repeat New Password</label>
							<input class="form-control" type="text" name="confirmpass" placeholder="" required />
						</div>
	  	            </div>  
                </div>
		</form>
