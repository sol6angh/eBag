...
<html lang="en">
<head>
  <title>Policy and Agreement</title>
  <link rel="shortcut icon" href="assets/img/test.png" type="image/x-icon">
  <meta charset="utf-8">
...
<body>
    ...
    <div class="container-fluid mt-2">
        <div style="background-color: #ECF0F1; padding: 70px;">
...
<p>As long as the website and the information and services on the website are provided free of charge, we will not be liable for any loss or damage of any nature.</div>
    ...
    <footer class="container-fluid text-center">
                <h6 class="text-light">&copy 2020 My e-bag. All Rights Reserves.</h6>  
    </footer>
