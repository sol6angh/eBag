...
<?php else: ?>
  ...
  <?php else: ?>
    <a style="font-size: 11px; color: black; text-align: center; margin-left: 50px;" href ="<?php echo base_url(); ?>View/view_b/search"><b><u>Advanced <br> Search</u></b></a>
      <form method="POST" action="<?php echo base_url(); ?>Document/search_for_material" style="margin-left: 10px;">
        <div class="input-group">
          <input type="text" class="form-control" name="search_for_material" size="55" placeholder="Search for material.." required>
          <div class="input-group-append">
...
<?php endif; ?>
    ...
    <div class="container2">
      <header>
        &emsp;<h1>(<?php echo $university->university_name; ?>) Live Chat !</h1>
      </header>
      <div class="shouts">
        <iframe src="<?php echo base_url(); ?>Community/get_chat/<?php echo $university->id; ?>" class="shouts" style="border:none;"></iframe>
      </div>
      <?php if($this->session->id): ?>
          <?php if($this->session->university_id == $university->id): ?>
            <div class="input">
              <form method="post" action="<?php echo base_url(); ?>Community/send_chat">
                <br/>
                <span>
                  ...
                  <input type="text" style="height: 40px; width: 85%; padding:0; margin-bottom: 20px; border: 1px solid black; border: 2px solid black; border-radius: 5px;" name="message" placeholder=" Enter your message here.." required/>
                  <button type="submit" class="shout-button" style="padding: 5px; margin-bottom: 20px; width: 10%; margin: 10px auto; border: 2px solid black; border-radius: 5px;"> Send</button>
                </span>
              </form>
            </div>
          <?php else: ?>
            <h5 style="text-align: center; padding: 5px;">Sorry you are not belong to this university you can not send a message in this chat, or you did not set your information study.</h5>
            <h5 style="text-align: center; padding: 5px;"><a href="<?php echo base_url(); ?>User/view_profile/<?php echo $this->session->id; ?>" class="text-danger">You better check your profile</a></h5>
          <?php endif; ?>

      <?php else: ?>
        <h4 style="text-align: center; padding: 15px;"><a href="<?php echo base_url(); ?>View/view_pages/login">Please login to your account to send a message.</a></h4>
      <?php endif; ?>
    </div>
      ...
      <div class="row ml-5">    
          ...
          <div class="col-md-3 col-sm-6 col-xs-12 segment-one">
            <h2 style="font-size: 20px;">My e-bag</h2>
              <a style="font-size: 15px; color: white;" href="<?php echo base_url(); ?>View/view_b/about">About us</a><br>
              <a style="font-size: 15px; color: white;" href="<?php echo base_url(); ?>View/view_o/signup">Sign up</a><br>
              <a style="font-size: 15px; color: white;" href="<?php echo base_url(); ?>View/view_o/login">Login</a>
          </div>

          <div class="col-md-3 col-sm-6 col-xs-12 segment-two">
            <h2 style="font-size: 20px;">Legal</h2>
              <a style="font-size: 15px; color: white;" target="_blank" href="<?php echo base_url(); ?>policy">Terms and Conditions</a><br>
              <a style="font-size: 15px; color: white;" target="_blank" href="<?php echo base_url(); ?>policy">Privacy Policy</a>
              </ul>
          </div>

          <div class="col-md-3 col-sm-6 col-xs-12 segment-three">
            <h2 style="font-size: 20px;">Help</h2>
              <a style="font-size: 15px; color: white;" href="<?php echo base_url(); ?>View/view_b/contact">Contact Us</a><br>
              <a style="font-size: 15px; color: white;" href="<?php echo base_url(); ?>View/view_b/faq">FAQ</a>
          </div>
